...
Also you can open files(only text files!) and see what is written in them. You are able to edit the file's content by adding and deleting using Backspace(however, you can't move the cursor).
